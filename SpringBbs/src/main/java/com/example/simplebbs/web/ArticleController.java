...
public class ArticleController {
	...
	@PostMapping("/write")
	public String submitForm(@Validated @ModelAttribute("articleInput") ArticleInput articleInput, BindingResult bindingResult) {
		System.out.println("article : " + articleInput);
